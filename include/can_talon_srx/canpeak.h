#ifndef CAN_TALON_SRX_ROS_CANPEAK_IMPL_H
#define CAN_TALON_SRX_ROS_CANPEAK_IMPL_H
...
class CanPeakInterface : public CanInterface
{
private:
    struct Message
    {
...
protected:
    CanPeakInterface(const char *interface_name);
